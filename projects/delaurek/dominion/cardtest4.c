...
printf("----------------------------------------------------------------------------\n");
printf("-----TEST 1:Testing when at least 1 cards available to draw-----\n\n");

// copy the game state to a test case
memcpy(&testerControlledG, &gameControlledG, sizeof(struct gameState));
cardEffect(village, choice1, choice2, choice3, &gameControlledG, handpos, &bonus);
...
printf("----------------------------------------------------------------------------\n");
printf("\n-----TEST 2:Testing when 0 cards available to draw-----\n\n");
