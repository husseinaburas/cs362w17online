...
int main() {
	...
	// play adventurer (G1)
	cardEffect(adventurer, -1, -1, -1, &G1, 0, 0);
	...
	// play adventurer (G2)
	cardEffect(adventurer, -1, -1, -1, &G2, 0, 0);
	...
	// play adventurer
	cardEffect(adventurer, -1, -1, -1, &G3, pos, 0);
	...
	// play adventurer
	cardEffect(adventurer, -1, -1, -1, &G4, 0, 0);
	...
	// play adventurer
	cardEffect(adventurer, -1, -1, -1, &G5, 0, 0);
