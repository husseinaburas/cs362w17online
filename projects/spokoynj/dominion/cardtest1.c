...
int main() {
	...
	// set smithy as first card in player's hand
	...
	printf("TEST 1 - cards in hand +2\n");
	// start with 5 cards in hand + 3 - 1 = 7
  	expected = 7;
	...
	printf("TEST 4 - check smithy in played cards\n");
	...
	printf("TEST 5 - deck count -3\n");
	// start with 5 cards in deck - 3 = 2
	expected = 2;
	...
	printf("\n--Testing with Smithy as Last Card in Player's Hand\n");
	
	// set smithy as last card in player's hand
	int pos = numHandCards(&G1) - 1;
	G1.hand[player][pos] = smithy;
	// play smithy
	playCard(pos, -1, -1, -1, &G1);

	// ----   TEST 11 - check numHandCards 	
	printf("TEST 11 - cards in hand +2\n");
	// start with 5 cards in hand + 3 - 1 = 7
  	expected = 7;
	...
	printf("\n--Testing with Smithy as Only Card in Player's Hand\n");
	
	// set smithy as the only card in player's hand
	G3.handCount[player] = 1;
	G3.hand[player][0] = smithy;
	// play smithy
	playCard(0, -1, -1, -1, &G3);
	
	// ----   TEST 13 - check numHandCards 	
	printf("TEST 13 - cards in hand +2\n");
	// start with 1 card in hand + 3 - 1 = 3
  	expected = 3;
