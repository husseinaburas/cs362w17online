...
//  Assignment 4
//
//  Random testing generator for the Village card
//
...
int main(int argc, char* args[]){
    ...
    for (i=0; i<50; i++) {
        ...
        assert_true(handCount == G.handCount[G.whoseTurn]);
        assert_true(deckCount == G.deckCount[G.whoseTurn] - 1);
        assert_true(G.numActions == 2);
