...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case steward:
		stewardCard(currentPlayer, choice1, choice2, choice3, handPos, state);
		
    case tribute:
		tributeCard(currentPlayer, state);
    ...
    case embargo: 
		embargoCard(state, handPos, currentPlayer, choice1);
...
int stewardCard(int currentPlayer, int choice1,  int choice2, int choice3, int handPos, struct gameState *state)
{
			  if (choice1 == 1)
		  {
			  //+2 cards
...
int embargoCard(struct gameState *state, int handPos, int currentPlayer, int choice1)
{
	//+2 Coins
	state->coins = state->coins + 2;
