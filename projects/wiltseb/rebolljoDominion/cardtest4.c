...
int main(){
	...
	*/
	...
	result = cardEffect(remodel, 0, estate, 0, &TestGame1, 5, &bonus); //should work because estate is worth 2 more than cost of trashed card
	...
	*/
	...
	result = cardEffect(remodel, 0, smithy, 0, &TestGame2, 5, &bonus); //should NOT work because smithy is worth 4 more than cost of trashed card
