...
int main(){
	...
	for (j = 0; j < 100000; j++){
		...
		*/
		...
		if (initDeckCount < 2){
			expectedDeckCount += TestGame1.discardCount;
		}

		playSteward(&TestGame1, currPlayer, stewardPos, 1, 0, 0);
		...
		*/
		...
		playSteward(&TestGame2, currPlayer, stewardPos, 2, 0, 0);
		...
		*/
		...
		playSteward(&TestGame3, currPlayer, stewardPos, 3, c1, c2);
