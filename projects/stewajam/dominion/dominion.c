...
// Added Function: play_smithy_card
...
// Added Function: play_adventurer_card
...
// Added Function: play_council_room
...
// Added Function: play_great_hall
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
	// calls play_adventurer_card function
    case adventurer:
	...
	// calls play_remodel function
    case remodel:
		play_remodel(state, currentPlayer, choice1, choice2, handPos, j);

	// calls play_smithy_card function
    case smithy:
