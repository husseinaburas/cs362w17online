...
//2k17/02/07
//Unit Test for Adventurer Card implementation playAdventurer()
...
//initialize the game state to where we could test the function under different game states
	...
	failFlag += assertTrue(preCardHandCount ==  G.handCount[thisPlayer] - 2 + 1); //got 2 new cards.
