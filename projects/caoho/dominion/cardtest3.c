...
int main() {
	...
	printf("****** Testing Method <playVillage ;>******\n");
	...
	initializeGame(playerNum, k, rSeed, state1);
	...
	initializeGame(playerNum, k, rSeed, state2);
	...
	initializeGame(playerNum, k, rSeed, state3);
	...
	initializeGame(playerNum, k, rSeed, state4);
	...
	initializeGame(playerNum, k, rSeed, state5);
