...
void runVillage (struct gameState *state, int currentPlayer) {
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    if (card == adventurer) {
        //refactored code
        runAdventurer (state, currentPlayer);
        return 0;
    }
        ...
        //refactored code
        runVillage (state, currentPlayer);
        ...
        //refactored code
        runCutPurse (state, currentPlayer);
