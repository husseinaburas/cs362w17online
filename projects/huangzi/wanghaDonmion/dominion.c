...
int smithy_action(int handPos, struct gameState *state, int currentPlayer){
...
int adventurer_action(int currentPlayer, struct gameState *state){
    int z = 0;
    int drawntreasure = 0;
    int cardDrawn;
...
int council_room_action(int handPos, int currentPlayer, struct gameState *state){
    //+4 Cards
    int i;
    for (i = 0; i < 4; i++)
    {
...
int village_action(int handPos, int currentPlayer, struct gameState *state){
    //+1 Card
    drawCard(currentPlayer, state);
...
int great_hall_action(int handPos, int currentPlayer, struct gameState *state){
    //+1 Card
    drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    if (card == smithy){
        return smithy_action(handPos, state, currentPlayer);
    }
    else if(card == adventurer){
        return adventurer_action(currentPlayer, state);
    }
    else if(card == council_room){
        return council_room_action(handPos, currentPlayer, state);
    }
    else if(card == village){
        return village_action(handPos, currentPlayer, state);
    }
    else if(card == great_hall){
        return great_hall_action(handPos, currentPlayer, state);
    }
