...
int cardAdventurer(int player, struct gameState *state);
int cardSmithy(int handPos, int player, struct gameState *state);
int cardOutpost(int handPos, int player, struct gameState *state);
