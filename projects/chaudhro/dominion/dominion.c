...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case cutpurse:
      ...
      cutpursecard(handPos, currentPlayer, state);	
    ...
    case treasure_map:
      treasuremapcard(handPos, currentPlayer, state);
	  return 0;
...
int adventurercard(int currentPlayer, struct gameState* state){
	int z = 0, cardDrawn, drawntreasure = 0;
...
int cutpursecard(int handPos, int currentPlayer, struct gameState* state){
	int i, j, k;
