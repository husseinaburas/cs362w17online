...
int checkSmithyCall(int n, int i, int handPos, int currentPlayer, struct gameState *post) {
   ...
   printf("before smithi call\n");
   int r = smithi(i, handPos, currentPlayer, post);       //function call

   printf("after smithi call\n");
