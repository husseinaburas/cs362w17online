 ...
 * draw cards from deck until two treasures are exposed
 * bug: changed:FROM while(z-1>=0){ TO while(z-1>0){
   */
...
int main(int argc, char* argv[]) {
	...
	// TEST 2A: INITIALIZE A NEW GAME STATE AND PLAYER CARDS (SEED DECK WITH ONLY ONE COPPER)
