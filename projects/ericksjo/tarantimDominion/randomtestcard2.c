/*
	randomtestcard2.c: Testing the Village card.
...
int main(int argc, char* argv[]) {
	...
	if (argc != 2 || argv[1] < 0) {
		printf("Correct Usage: randomtestcard2 <positive random seed>\n");
		exit(0);
	}
	...
	for (i = 0; i < 1000; i++){
		...
		villageCard(&testGame, testGame.handCount[currentPlayer] - 1, currentPlayer);
