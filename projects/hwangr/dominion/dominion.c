...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  //Below 3 variables originally needed for adventurer card, that section has been moved to its own function 
  //int drawntreasure=0;
  //int cardDrawn;
  ...
  switch( card ) 
    {
    case adventurer:
      //Card functionality implemented in separate function
...
//Implements Smithy card functionality
...
//Implements Council Room card functionality
...
//Implements Great Hall card functionality
...
//Implements Steward card functionality
