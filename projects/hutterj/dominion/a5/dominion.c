...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
	// Testing: last played card discard problem by adding handPos param, JHutter
      return playAdventurer(state, drawntreasure, currentPlayer, cardDrawn, temphand, z, handPos);
    ...
    case steward:
      return playSteward(state, currentPlayer, handPos, choice1, choice2);
...
int playSmithy(struct gameState *state, int currentPlayer, int handPos)
{
	int i;
    //+3 Cards
	// Testing: fixed test expression here, JHutter
    for (i = 0; i < 3; i++)
    {
        drawCard(currentPlayer, state);
    }
...
// Testing: last played card discard problem by adding handPos param, JHutter
int playAdventurer(struct gameState *state, int drawntreasure, int currentPlayer, int cardDrawn, int temphand[], int z, int handPos)
{
	discardCard(handPos, currentPlayer, state, 0);
...
int playSteward(struct gameState *state, int currentPlayer, int handPos, int choice1, int choice2)
{
	int i;
