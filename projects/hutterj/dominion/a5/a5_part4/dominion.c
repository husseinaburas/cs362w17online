...
{
	int discPos = state->discardCount[currentPlayer];
	// Bug fix: add card to discard pile, increment discard count
	state->discard[currentPlayer][discPos] = state->hand[currentPlayer][handPos];
	state->discardCount[currentPlayer] = discPos + 1;
