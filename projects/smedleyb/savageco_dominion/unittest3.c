...
int main(){
  ...
  // TEST 1a: discarded card goes to played cards pile
  printf("\n");
  if (s->playedCards[0] == cardToDiscard)
  ...
  // TEST 2a: discarded card goes to discard pile
  printf("\n");
  ...
  // TEST 2b: played (discarded) card count should be 1
  if (s->discardCount == 1)
