...
* Assignment 3
* cardtest4.c 
* Testing: int playRemodel(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos)
*
************************************************************************/
...
int main() {
    ...
    /* play Remodel */
    playRemodel(0, &actualState, 1, baron, 0);
    success = 0;
    ...
    memcpy(&copyState, &actualState, sizeof(struct gameState));
    /* play Remodel */
    playRemodel(0, &actualState, 1, province, 0);
    success = 0;
    ...
    memcpy(&copyState, &actualState, sizeof(struct gameState));
    /* play Remodel */
    playRemodel(0, &actualState, 1, village, 0);
    success = 0;
