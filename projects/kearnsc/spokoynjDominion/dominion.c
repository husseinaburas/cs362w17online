...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return adventurerCard(state, currentPlayer, handPos);
...
int adventurerCard(struct gameState *state, int currentPlayer, int handPos) {
  ...
  while(drawntreasure<3){		/* ***************** Should be "while(drawnTreasure < 2)" card action
							  is "Reveal cards from your deck until you reveal 2 Treasure cards". */
  ...
  //put played card in played card pile  ******* This line is added since original dominion code pull *******  
  discardCard(handPos, currentPlayer, state, 0);
