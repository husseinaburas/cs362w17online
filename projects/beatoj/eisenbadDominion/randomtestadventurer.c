...
void adventurerRandomTest(int *passed, int *failed){
    ...
    //playAdventurer(0, &test, currentPlayer, 0, temphand ,0);                //A5 - REFACTORED:  Removed all parameters except for gameState struct
    
    adventurer_refact(&test);                                                 //A5 - REFACTORED:  Used Teammate's refactored adventurer function outside of cardEffect() switch statement.  Only parameter is gameState struct. 
