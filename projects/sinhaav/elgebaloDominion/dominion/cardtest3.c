...
int main() {
	...
	playVillage(&testGame, currentPlayer, testGame.handCount[currentPlayer] - 1);
	...
	printf("Testing that current number of actions increased by 4\n");
	assertion(testGame.numActions == gameCopy.numActions + 4);
