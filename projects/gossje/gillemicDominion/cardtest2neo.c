...
int test_feast(struct gameState *game){
	...
	int t1 = playCard(0, adventurer, 0, 0, game); //adventurer too expensive. Should remain in supply. Shouldn't be in discard pile or hand of player. 
	...
	int t2 = playCard(0, gardens, 0, 0, game);
	...
	int t3 = playCard(0, smithy, 0, 0, game);
