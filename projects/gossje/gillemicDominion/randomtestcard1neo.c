...
int main(int argc, char **argv) {
	...
	for (i = 0; i < numCycles; i++) //5000 random tests 
	{
		...
		game.hand[player][handPos] = village; //set handpos card to village for updated test
		game.whoseTurn = player; //set current player to generated value for updated test
		...
		int t1 = playCard(handPos, 0, 0, 0, &game);
