...
int main(){
	...
	// ----------- TEST 3: Test number of actions is the same-----------
	printf("%s TEST 3: Number of actions after is the same\n", TESTCARD);
	if (result == 0){
	...
	// ----------- TEST 7: Test that the adventurer card is in the discard pile -----------
	printf("%s TEST 7: Adventurer card is in the discard pile\n", TESTCARD);
	if (result == 0){
	...
	// ----------- TEST 11 : Test amount of coins has increased -----------
	printf("%s TEST 11: Amount of coins has increased\n", TESTCARD);
	if (result == 0){
		tester = 0;
