...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus) {
  ...
  switch( card )
    ...
    case council_room:
      cardEffectCouncilRoom(currentPlayer, state, handPos);
      return 0;

    case feast:
	  cardEffectFeast(currentPlayer, state, handPos, choice1);
	  return 0;
    ...
    case mine:
	  cardEffectMine(currentPlayer, state, handPos, choice1, choice2);
	  return 0;
    ...
    case smithy:
      cardEffectSmithy( currentPlayer, state, handPos );
      return 0;
