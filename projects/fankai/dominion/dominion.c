...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
        Doadventurer(drawntreasure, state, currentPlayer, cardDrawn, temphand, z);
        return 0;
    ...
    case smithy:
      //+3 Cards
        DoSmithy(currentPlayer, state, handPos);
        return 0;

    case village:
        Dovillage(currentPlayer, state, handPos);
        return 0;
    ...
    case steward:
        Dosteward(choice1,choice2,choice3,state,currentPlayer,handPos);
        return 0;
    ...
    case embargo:
        Doembargo(currentPlayer, state, handPos,choice1);
      return 0;
...
int Doembargo(int currentPlayer, struct gameState *state, int handPos,int choice1){
      //+2 Coins
      state->coins = state->coins + 2;
