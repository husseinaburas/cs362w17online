...
{ 
  ...
  int randomPlayer, randomDrawn, randomInitSeed, preTreasure, postTreasure, preHandCount, postHandCount;
  ...
  for (n = 0; n < 2000; n++) 
  {
	...
	preHandCount = game.handCount[randomPlayer];
        adventurerCard(&game, randomPlayer, randomDrawn, drawntreasure, temphand, z);
	int u;
