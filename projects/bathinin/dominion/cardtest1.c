...
int main(){
	...
	printf("Testing smithy: P1 handcount should be %d, actual ",G.handCount[curPlayer] + newCards - discards);
	newCards = 3; 
	
	if (Gtwo.handCount[curPlayer] == G.handCount[curPlayer] + newCards - discards){
